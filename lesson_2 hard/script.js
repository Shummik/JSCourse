...
for (var i = 0; i < len; i += 1) {
    output.push(+sNumber.charAt(i)); /* Получаем символ, который занимает позицию i, также можно это сделать с помощью квадратных скобок: [i]. И затем добавляем push его в массив(знак +sNumer для целочисленного отображения элемента массива*/
    mult *=sNumber[i]; 
